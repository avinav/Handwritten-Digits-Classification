...
train_out_dict = preprocess_cpt(train_out_data,predicted_label,class_list)
...
savemat('conf_matrix_nn_bayes_out.mat',{'conf_matrix':conf_matrix,'conf_matrix_string':conf_matrix_string})
